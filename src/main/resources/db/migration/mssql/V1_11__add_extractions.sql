...
DROP INDEX UK_fsio2r4kfwoupmiljkt308he5 ON maven_artifact;
ALTER TABLE maven_artifact
  ADD id_action_extraction int NULL,
  CONSTRAINT FK_kivt0mkhrkjmxgj9dy9ge2eqd FOREIGN KEY (id_action_extraction) REFERENCES action_extraction (id);
ALTER TABLE maven_artifact
  ALTER COLUMN id_action_copy int NULL;
CREATE INDEX FK_kivt0mkhrkjmxgj9dy9ge2eqd ON maven_artifact (id_action_extraction);
GO

DROP INDEX UK_fxjsjddujg8pqxhsgf5wssyfi ON spacer_url;
ALTER TABLE spacer_url
  ADD id_action_extraction int NULL,
  CONSTRAINT FK_qrup4t5c0gjextscs4fuj63ap FOREIGN KEY (id_action_extraction) REFERENCES action_extraction (id);
ALTER TABLE spacer_url
  ALTER COLUMN id_action_copy int NULL;
